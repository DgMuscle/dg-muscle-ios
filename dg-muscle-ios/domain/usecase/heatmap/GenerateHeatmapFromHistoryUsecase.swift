//
//  GenerateHeatmapFromHistoryUsecase.swift
//  dg-muscle-ios
//
...
final class GenerateHeatmapFromHistoryUsecase {
    ...
    func implement(histories: [HistoryDomain]) -> [HeatmapDomain] {
        ...
        let heatmaps: [HeatmapDomain] = hashMap
            .map({ .init(id: UUID().uuidString, week: $0.key, volumes: $0.value.map({ $0 })) })
